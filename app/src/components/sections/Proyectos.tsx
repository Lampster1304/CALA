  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          className="absolute top-[10%] left-[15%] w-[350px] h-[350px] rounded-full bg-violet-600/[0.05] blur-[130px]"
          style={{ animation: "float 25s ease-in-out infinite" }}
        />
        <div
          className="absolute bottom-[15%] right-[10%] w-[300px] h-[300px] rounded-full bg-indigo-600/[0.05] blur-[120px]"
      ...
      <div className="max-w-7xl w-full relative z-10">
        ...
        <div ref={headerRef} className="mb-14 md:mb-20">
          ...
          <h2 className="font-[family-name:var(--font-orbitron)] text-4xl sm:text-5xl lg:text-7xl font-bold leading-[1.05] tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 lg:grid-rows-2 gap-5">
          {/* Hero card — spans left 3 cols, both rows */}
          <div className="project-card group relative lg:col-span-3 lg:row-span-2 min-h-[350px] lg:min-h-0 rounded-2xl overflow-hidden cursor-pointer">
            <Image
            ...
            <div className="absolute bottom-0 left-0 right-0 p-7 sm:p-9 transition-transform duration-500 group-hover:translate-y-[-4px]">
              ...
              <p className="font-[family-name:var(--font-inter)] text-white/60 text-base font-light max-w-md lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-500">
                {proyectosData[0].desc}
              </p>
            </div>

            {/* Subtle border glow on hover */}
            <div className="absolute inset-0 rounded-2xl border border-white/[0.06] group-hover:border-violet-500/20 transition-colors duration-500" />
          </div>
          ...
          {proyectosData.slice(1).map((proy, idx) => (
            <div
              key={idx}
              className="project-card group relative lg:col-span-2 min-h-[250px] rounded-2xl overflow-hidden cursor-pointer"
            >
              <Image
                src={proy.image}
                alt={proy.title}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 transition-transform duration-500 group-hover:translate-y-[-3px]">
                ...
                <p className="font-[family-name:var(--font-inter)] text-white/50 text-sm font-light lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-500">
                  {proy.desc}
                </p>
              </div>
